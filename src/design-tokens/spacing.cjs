const css = `
/* @link https://utopia.fyi/space/calculator?c=320,16,1.125,1240,18,1.25,9,2,&s=0.75|0.5|0.25,1.5|2|3|4|6,s-l&g=s,l,xl,12 */
...
:root {
  ...
  /* Custom pairs */
  --space-s-l: clamp(1.00rem, calc(0.57rem + 2.17vw), 2.25rem);
}
`;
